package ms.izzi.legacyPortalsServices.config;
...
/**
 * Archivo de configuracion de Spring para la parte 
 * de persitencia.
 * 
 *
 */
@Configuration
@EnableJpaRepositories(basePackages="ms.izzi.legacyPortalsServices.repository",transactionManagerRef="transactionManager")
...
public class PersistenceConfig 
{
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory()
	{
		...
		//vendorAdapter.setShowSql(Boolean.FALSE);  <==== PROD
		vendorAdapter.setShowSql(Boolean.TRUE);
		factory.setDataSource(getDataSource());
		factory.setJpaVendorAdapter(vendorAdapter);
		factory.setPackagesToScan(new String[]{"ms.izzi.legacyPortalsServices.model"});
