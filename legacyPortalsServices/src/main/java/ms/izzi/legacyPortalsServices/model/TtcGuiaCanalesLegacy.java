package ms.izzi.legacyPortalsServices.model;
...
@NamedQuery(name="TtcGuiaCanalesLegacy.findAll", query="SELECT c FROM TtcGuiaCanalesLegacy c")
public class TtcGuiaCanalesLegacy implements Serializable {
	...
	public String toString() {
		return "TtcGuiaCanalesLegacy [id=" + id + ", msoEmpresa=" + msoEmpresa
				+ ", ciudad=" + ciudad + ", numCanal=" + numCanal
				+ ", descCanal=" + descCanal + ", flagMiniBasico="
				+ flagMiniBasico + ", flagBasico=" + flagBasico + ", status="
				+ status + "]";
	}
